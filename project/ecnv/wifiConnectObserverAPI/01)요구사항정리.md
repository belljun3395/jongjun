...
| Usecase                                                      | Phase | Note                                                         | Domain          | Table                                             |
| ------------------------------------------------------------ | ----- | ------------------------------------------------------------ | --------------- | ------------------------------------------------- |
| 사용자는 자신의 Wifi 정보를 바탕으로 서비스를 등록할 수 있다. | 1     | 공유기 ip를 기반으로 구현(동적, 고정ip 구분하여 받기)<br /><br />기기등록 기능을 원하는 사용자만 사용할 수 있도록 서비스 등록시 이를 구분하여 구현<br /> | Member, Wifi    | Member, WifiInfo                                  |
...
| 자신의 Wifi 정보 중 ip 정보가 동적 ip라고 선택한 사용자는<br />ip 정보가 바뀌어 서비스가 정상적으로 작동하지 않는 경우에 email을 통해 해당 사실을 받을 수 있다. | 1     |                                                              | Membmer, Wifi   | Member, WifiInfo                                  |
...
| 사용자는 등록한 기기의 통계를 한달마다 email을 통해 받을 수 있다. | 2     |                                                              | Member, Device  | Member, Device, ConnectHistory                    |
